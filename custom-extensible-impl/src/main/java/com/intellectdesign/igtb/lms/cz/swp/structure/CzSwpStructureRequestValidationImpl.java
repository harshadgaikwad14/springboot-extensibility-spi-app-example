...
public class CzSwpStructureRequestValidationImpl implements CzSwpStructureRequestValidation<Object, ApiSubError> {

	public CzSwpStructureRequestValidationImpl() {
		super();
	}
